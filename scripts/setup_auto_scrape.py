#!/usr/bin/env python3
"""
Script to setup automated scraping on the server.
This will:
1. Run an initial full scrape
2. Set up a cron job to run scraping every 6 hours
"""
...
def main():
    ...
    print("Starting full scrape of all categories...")
    try:
