...
import { MagnifyingGlassIcon, FunnelIcon, BellIcon, DocumentTextIcon } from '@heroicons/react/24/outline';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              <span className="text-sm text-gray-700">Γεια σου, {user?.email}</span>
              <button
