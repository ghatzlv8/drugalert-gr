...
import { Search, Filter, FileText, AlertCircle, Calendar, Package } from 'lucide-react';
  ...
  return (
    <Layout>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Beta Dashboard - Όλες οι Κατηγορίες</h1>
